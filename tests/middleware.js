...
describe('middleware', function () {
	...
	it('40X - rejects if no version header is included', function (done) {
		var expectedCode = settings.errorStatusCode;
		var expectedError = {
	...
	it('40X - invalid platform in header', function (done) {
		var expectedCode = settings.errorStatusCode;
		var expectedError = {
	...
	it('40X - invalid platform version in header', function (done) {
		var expectedCode = settings.errorStatusCode;
		var expectedError = {
			err: "invalid_version",
	...
	it('40X - old platform version in header', function (done) {
		var expectedCode = settings.errorStatusCode;
		var expectedError = {
			err: "invalid_version",
			des: "Must update to last application version",
